...
const DeputyDashboard = () => {
  ...
  const billsStats = {
    ...
    votees: myBills.filter((b) =>
      [BillStatus.adoptee, BillStatus.rejetee].includes(b.etat)
    ).length,
  };
              ...
              <div className="space-y-2">
                ...
                <div className="text-sm text-gray-600 space-y-1">
                  <p>
                    ...
                    {user?.groupe_parlementaire || "Non défini"}
                  </p>
                  <p>
                    <strong>Circonscription:</strong>{" "}
                    {user?.circonscription || "Non définie"}
                  </p>
                  <p>
                    <strong>Parti politique:</strong>{" "}
                    {user?.partie_politique || "Non défini"}
                  </p>
                  <p>
                    <strong>Poste dans le parti:</strong>{" "}
                    {user?.poste_partie || "Non défini"}
                  </p>
                </div>
              </div>
            </div>
